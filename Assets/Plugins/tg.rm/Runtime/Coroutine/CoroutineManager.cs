...
namespace TG.AssetBundleRM
{
    ...
    public static class DeferExtensionMethods
    {
        ...
        {
            while (CoroutineManager.MainThread != System.Threading.Thread.CurrentThread || (gameObject && gameObject.activeInHierarchy && coroutine.MoveNext()))
        ...
        {
            while (CoroutineManager.MainThread != System.Threading.Thread.CurrentThread || (gameObject1 && gameObject1.activeInHierarchy &&
